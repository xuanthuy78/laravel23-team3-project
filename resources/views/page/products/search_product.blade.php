				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							@if($productKey != "")
							<h3 class="wthree_text_info">Key: <span>{{$productKey}} - Giá từ: <span>{{number_format($strMin)}} VND - {{number_format($strMax)}} VND</span>
							@else
							<h3 class="wthree_text_info">Giá từ: <span>{{number_format($strMin)}} VND - {{number_format($strMax)}} VND</span>
							@endif
